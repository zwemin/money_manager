...
import 'package:money_manager/pages/outcome/monthpage.dart';

class MonthlyOutcomepage extends StatefulWidget {
  NoteDao dao;
  MonthlyOutcomepage({this.dao});
  @override
  _MonthlyOutcomepageState createState() => _MonthlyOutcomepageState();
}

class _MonthlyOutcomepageState extends State<MonthlyOutcomepage> {
